...
------------------------------------
  ...
  I.3  Spatial representation
       EV06b uses IDW P1+P2 hourly (w1=0.3953, w2=0.6047), with
       inter-station correlation r_vpd = 0.90–0.98. IDW weights are
       consistent with EV05. Higher Rendheng variability at P2
       (bias_vpd P2−P1 = +0.02 to +0.04 kPa) is reflected in the
       wider CI — a valid physical signal, not a degradation of mean
       accuracy. (The single-station limitation of the initial EV06
       has been resolved.)
  ...
  II.A  Type A uncertainty — Estimation precision (interannual SE)
        ...
        95% CI of VPD, representative per mangsa (EV06b IDW P1+P2):
        ...
        95% CI of sun_h, representative per mangsa (EV06b IDW P1+P2):
...
# EV06b: IDW-merged P1+P2 hourly, 2015–2025.
METEO_MANGSA_6H: Dict[int, Tuple] = {
     1: (1.352, 35.2, 49, 55, 10.84, 0.154, 0.335, 26.9, 26.8),
     2: (1.551, 33.7, 48, 51, 11.00, 0.132, 0.321, 27.7, 27.0),
     3: (1.690, 35.8, 55, 60, 11.04, 0.126, 0.312, 28.4, 27.2),
     4: (1.601, 39.6, 65, 66, 10.94, 0.134, 0.301, 29.1, 27.5),
     5: (1.181, 46.6, 77, 78, 10.11, 0.271, 0.291, 28.4, 27.9),
     6: (0.629, 52.4, 91, 91,  8.53, 0.379, 0.291, 26.8, 27.9),
     7: (0.467, 53.7, 92, 93,  7.70, 0.394, 0.377, 26.2, 27.2),
     8: (0.468, 52.7, 88, 90,  8.47, 0.396, 0.404, 26.2, 26.9),
     9: (0.532, 52.2, 84, 87,  9.11, 0.386, 0.403, 26.5, 26.7),
    10: (0.656, 49.5, 77, 79,  9.62, 0.360, 0.395, 26.6, 26.7),
    11: (0.949, 45.2, 63, 66, 10.34, 0.313, 0.377, 26.9, 26.8),
    12: (1.021, 43.2, 61, 65, 10.34, 0.235, 0.356, 26.7, 26.8),
}
...
def show_menu() -> None:
    print(); print(box_top("PRANATA MANGSA — EV07 METEO(DAILY+6H)+ENSO+IOD+ASTRO"))
